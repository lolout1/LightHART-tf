# LightHART-TF: Cross-Modal Knowledge Distillation for Fall Detection
...
The original LightHART was written in PyTorch and has trouble converting directly to tensorflow lite due to issues with dynamic shape sizes, unsupported model operations, etc. 
